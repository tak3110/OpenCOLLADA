...
//AD_EXPORT_CGFX_PATH_STATE
        {
            ...
            case COLLADASW::RenderState::ALPHA_FUNC:
                {
                    ...
                    //AlphaFuncでRef値が設定されていない場合、第二要素には無効な値が設定されるらしいので注意.
            ...
            case COLLADASW::RenderState::BLEND_FUNC:
                {
                    ...
                    param.openParam ();
                    {
                        const char* cgStateEnum;
                        COLLADASW::RenderState::PassStateBlendFunction passStateBlendFunction;
                        String renderStateBlendFunctionName;

                        cgStateEnum = cgGetStateEnumerantName( cgState, values[0] );
                        passStateBlendFunction = COLLADASW::RenderState::getPassStateBlendFuncFromCgName( cgStateEnum );
                        renderStateBlendFunctionName = COLLADASW::RenderState::getColladaPassStateBlendFunctionString ( passStateBlendFunction );
                        param.appendAttribute( "src" , renderStateBlendFunctionName );

                        cgStateEnum = cgGetStateEnumerantName( cgState, values[1] );
                        passStateBlendFunction = COLLADASW::RenderState::getPassStateBlendFuncFromCgName( cgStateEnum );
                        renderStateBlendFunctionName = COLLADASW::RenderState::getColladaPassStateBlendFunctionString ( passStateBlendFunction );
                        param.appendAttribute( "dest", renderStateBlendFunctionName );
                    }
                    param.closeParam();
#endif//1
            ...
            case COLLADASW::RenderState::BLEND_EQUATION:
                ...
                break;
/*
            case COLLADASW::RenderState::BLEND_FUNC_SEPARATE:
                {
                    ...
                    param.openParam ();
                    {
                        ...
                        passStateBlendFunction = COLLADASW::RenderState::getPassStateBlendFuncFromCgName( cgStateEnum );
                        renderStateBlendFunctionName = COLLADASW::RenderState::getColladaPassStateBlendFunctionString ( passStateBlendFunction );
                        param.appendAttribute( "srcRGB" , renderStateBlendFunctionName );

                        cgStateEnum = cgGetStateEnumerantName( cgState, values[1] );
                        passStateBlendFunction = COLLADASW::RenderState::getPassStateBlendFuncFromCgName( cgStateEnum );
                        renderStateBlendFunctionName = COLLADASW::RenderState::getColladaPassStateBlendFunctionString ( passStateBlendFunction );
                        param.appendAttribute( "dstRGB", renderStateBlendFunctionName );

                        cgStateEnum = cgGetStateEnumerantName( cgState, values[2] );
                        passStateBlendFunction = COLLADASW::RenderState::getPassStateBlendFuncFromCgName( cgStateEnum );
                        renderStateBlendFunctionName = COLLADASW::RenderState::getColladaPassStateBlendFunctionString ( passStateBlendFunction );
                        param.appendAttribute( "srcAlpha" , renderStateBlendFunctionName );

                        cgStateEnum = cgGetStateEnumerantName( cgState, values[3] );
                        passStateBlendFunction = COLLADASW::RenderState::getPassStateBlendFuncFromCgName( cgStateEnum );
                        renderStateBlendFunctionName = COLLADASW::RenderState::getColladaPassStateBlendFunctionString ( passStateBlendFunction );
                        param.appendAttribute( "dstAlpha", renderStateBlendFunctionName );
                    }
                    param.closeParam();
