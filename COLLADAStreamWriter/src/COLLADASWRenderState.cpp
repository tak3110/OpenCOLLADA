...
/*
    // -------------------------------
    const RenderState::PassStateBlendFunction RenderState::getPassStateBlendFunction ( const char* val )
    {
             if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_ZERO                    ) ) return PASS_STATE_BLEND_FN_ZERO;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_ONE                     ) ) return PASS_STATE_BLEND_FN_ONE;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_SRC_COLOR               ) ) return PASS_STATE_BLEND_FN_SRC_COLOR;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_SRC_COLOR     ) ) return PASS_STATE_BLEND_FN_ONE_MINUS_SRC_COLOR;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_DEST_COLOR              ) ) return PASS_STATE_BLEND_FN_DEST_COLOR;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_DST_COLOR     ) ) return PASS_STATE_BLEND_FN_ONE_MINUS_DST_COLOR;             
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_SRC_ALPHA               ) ) return PASS_STATE_BLEND_FN_SRC_ALPHA;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_SRC_ALPHA     ) ) return PASS_STATE_BLEND_FN_ONE_MINUS_SRC_ALPHA;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_DST_ALPHA               ) ) return PASS_STATE_BLEND_FN_DST_ALPHA;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_DST_ALPHA     ) ) return PASS_STATE_BLEND_FN_ONE_MINUS_DST_ALPHA;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_CONSTANT_COLOR          ) ) return PASS_STATE_BLEND_FN_CONSTANT_COLOR;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_CONSTANT_COLOR) ) return PASS_STATE_BLEND_FN_ONE_MINUS_CONSTANT_COLOR;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_CONSTANT_ALPHA          ) ) return PASS_STATE_BLEND_FN_CONSTANT_ALPHA;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_ONE_MINUS_CONSTANT_ALPHA) ) return PASS_STATE_BLEND_FN_ONE_MINUS_CONSTANT_ALPHA;
        else if ( COLLADABU::Utils::equalsIgnoreCase ( val, CSWC::CSW_FX_BLEND_FUNCTION_SRC_ALPHA_SATURATE      ) ) return PASS_STATE_BLEND_FN_SRC_ALPHA_SATURATE;

        else return PASS_STATE_BLEND_FN_INVALID;
    }
*/
    // -------------------------------
